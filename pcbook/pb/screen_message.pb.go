...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=hemanth.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x28, 0x0b, 0x32, 0x21, 0x2e, 0x68, 0x65, 0x6d, 0x61, 0x6e, 0x74, 0x68, 0x2e, 0x70, 0x63, 0x62,
	...
	0x32, 0x1c, 0x2e, 0x68, 0x65, 0x6d, 0x61, 0x6e, 0x74, 0x68, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
	...
	0x12, 0x08, 0x0a, 0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: hemanth.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: hemanth.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: hemanth.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: hemanth.pcbook.Screen.resolution:type_name -> hemanth.pcbook.Screen.Resolution
	0, // 1: hemanth.pcbook.Screen.panel:type_name -> hemanth.pcbook.Screen.Panel
