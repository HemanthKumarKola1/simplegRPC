...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=hemanth.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xae, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x68, 0x65, 0x6d, 0x61, 0x6e, 0x74, 0x68, 0x2e,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x55, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: hemanth.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: hemanth.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: hemanth.pcbook.Memory.unit:type_name -> hemanth.pcbook.Memory.Unit
